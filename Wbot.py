...
class WhatsApp:
    ...
    def nav_input_box(self):
        try:
            ...
            pt.moveTo(position[0:2], duration=self.speed)
            pt.moveRel(120, 30, duration=self.speed)
            pt.doubleClick(interval=self.click_speed)
        except Exception as e:
    ...
    def nav_message(self):
        try:
            position = pt.locateOnScreen('paperclip.png', confidence=.7)
            pt.moveTo(position[0:2], duration=self.speed)
            pt.moveRel(60, -60, duration=self.speed)  # x,y has to be adjusted depending on your computer
        except Exception as e:
    ...
    def get_message(self):
        ...
        sleep(self.speed)
        pt.moveRel(30, 20, duration=self.speed)  # x,y has to be adjusted depending on your computer
    ...
    def nav_x(self):
        try:
            ...
            pt.moveTo(position[0:2], duration=self.speed)
            pt.moveRel(20, 25, duration=self.speed)  # x,y has to be adjusted depending on your computer
            mouse.click(Button.left, 1)
        except Exception as e:
